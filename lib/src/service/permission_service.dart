...
import 'package:permission_service/src/core/widget/permission_dialog.dart';
import 'package:permission_service/src/service/device_info_service.dart';
...
class PermissionService {
  ...
  static Future<bool> requestLocationPermission(BuildContext context) async {
    ...
    if (locationPermission == LocationPermission.whileInUse ||
        locationPermission == LocationPermission.always) return true;
    ...
    if (requestPermission == LocationPermission.whileInUse ||
        requestPermission == LocationPermission.always) return true;
    if (locationPermission == LocationPermission.deniedForever ||
      ...
      _showPermissionDeniedBottomSheet(
        ...
        message:
            'The app needs access to your location to provide location-based services. Please enable the location permission in the app settings.',
      );
    }
    return false;
  }
